...
- `plugins/` に標準パネル6種の UI DSL + Rust SDK + Wasm 版を追加した
...
- `plugins/` に `builtin.app-actions` / `builtin.tool-palette` / `builtin.layers-panel` の `.altp-panel` と対応 Wasm runtime を追加した
