...
- `plugin_sdk::host::tool::pen_name()`
- `plugin_sdk::host::tool::pen_size()`
- `plugin_sdk::host::tool::active_id()`
- `plugin_sdk::host::tool::active_label()`
- `plugin_sdk::host::tool::active_provider_plugin_id()`
- `plugin_sdk::host::tool::active_drawing_plugin_id()`
- `plugin_sdk::host::tool::supports_*()`
