...
declare -A PANELS=(
  ...
  ["builtin-panel-koma-list"]="crates/builtin-panels/koma-list/builtin_panel_koma_list.wasm"
  ["builtin-panel-layers"]="crates/builtin-panels/layers/builtin_panel_layers.wasm"
  ["builtin-panel-color-palette"]="crates/builtin-panels/color-palette/builtin_panel_color_palette.wasm"
  ["builtin-panel-tool-settings"]="crates/builtin-panels/tool-settings/builtin_panel_tool_settings.wasm"
